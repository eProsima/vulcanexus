...
For a deeper explanation of the Vulcanexus HRI messages or a direct comparison on a practical use case, please refer to the :ref:`enhancements_hri_msgs` section.
