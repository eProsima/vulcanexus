.. _cloud_wan_tcp_edge_cloud_arch_wan_tcp_edge_cloud_arch:
...
1.  **ROS 2 Router / DDS Router**.
    *eProsima ROS 2 Router*, a.k.a `DDS Router <https://github.com/eProsima/DDS-Router>`_, is an end-user software application that enables the connection of distributed ROS 2 networks.
...
.. figure:: /rst/figures/cloud/turtlesim_node.png
   :scale: 75%
   :align: center
...
.. literalinclude:: ../../../../../resources/tutorials/edge_cloud_arch/dds_router_edge.yaml
    :language: yaml
