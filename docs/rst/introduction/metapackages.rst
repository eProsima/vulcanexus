...
.. note::
    ...
    Consequently, in order to install this package run the following command after setting up the repository as explained in the :ref:`installation guide <linux_binary_installation>`
        ...
        .. code-block:: bash
            ...
            sudo apt install vulcanexus-kilted-core
...
.. note::
    ...
    Consequently, in order to install this package run the following command after setting up the repository as explained in the :ref:`installation guide <linux_binary_installation>`
        ...
        .. code-block:: bash
            ...
            sudo apt install vulcanexus-kilted-tools
...
.. note::
    ...
    Consequently, in order to install this package run the following command after setting up the repository as explained in the :ref:`installation guide <linux_binary_installation>`
        ...
        .. code-block:: bash
            ...
            sudo apt install vulcanexus-kilted-micro
...
.. note::
    ...
    Consequently, in order to install this package run the following command after setting up the repository as explained in the :ref:`installation guide <linux_binary_installation>`
        ...
        .. code-block:: bash
            ...
            sudo apt install vulcanexus-kilted-cloud
...
.. note::
    ...
    Consequently, in order to install this package run the following command after setting up the repository as explained in the :ref:`installation guide <linux_binary_installation>`
        ...
        .. code-block:: bash
            ...
            sudo apt install vulcanexus-kilted-simulation
...
.. note::
    ...
    Consequently, in order to install this package run the following command after setting up the repository as explained in the :ref:`installation guide <linux_binary_installation>`
        ...
        .. code-block:: bash
            ...
            sudo apt install vulcanexus-kilted-base
...
.. note::
    ...
    Consequently, in order to install this package run the following command after setting up the repository as explained in the :ref:`installation guide <linux_binary_installation>`
        ...
        .. code-block:: bash
            ...
            sudo apt install vulcanexus-kilted-desktop
