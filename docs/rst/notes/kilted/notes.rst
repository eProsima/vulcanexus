...
.. list-table::
    ...
    * - micro-ROS Agent
      ...
      - v4.0.0
    * - micro-ROS Setup
      - `6.0.0 <https://github.com/micro-ROS/micro_ros_setup/blob/6.0.0/CHANGELOG.rst#600-2025-07-02>`__
      - v4.0.0
    ...
    * - ROS 2 Monitor
      ...
      - v5.0.0
    * - ROS 2 Router
      - `v3.3.0 <https://eprosima-dds-router.readthedocs.io/en/latest/rst/notes/notes.html#version-v3-3-0>`__
      - v5.0.0
    * - ROS 2 Shapes Demo
      - `v3.3.0 <https://eprosima-shapes-demo.readthedocs.io/en/latest/notes/previous_versions/supported_versions.html#version-3-3>`__
      - v5.0.0
    ...
    * - ROS 2 Statistics Backend
      - `v2.3.0 <https://fast-dds-statistics-backend.readthedocs.io/en/latest/rst/notes/notes.html>`__
      - v5.0.0
    * - Vulcanexus Fast DDS RMW
      - `9.4.2 <https://github.com/eProsima/rmw_fastrtps/releases/tag/9.4.2>`__
      - v5.0.0
    * - eProsima Dev Utils
    ...
    * - eProsima DDS Record & Replay
      - `v1.3.0 <https://dds-recorder.readthedocs.io/en/latest/rst/notes/notes.html#version-v1-3-0>`__
      - v5.0.0
