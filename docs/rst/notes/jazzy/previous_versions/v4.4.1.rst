...
.. list-table::
    ...
    * - ROS 2 Statistics Backend
      - `v2.4.0 <https://fast-dds-statistics-backend.readthedocs.io/en/latest/rst/notes/notes.html#version-2-4-0>`__
      - v4.4.0
    ...
    * - Vulcanexus IDL Dynamic TypeSupport Fast DDS
      ...
      - v4.1.0
    * - Vulcanexus Base
      - `v4.4.1 <https://docs.vulcanexus.org/en/latest/rst/notes/jazzy/notes.html#jazzy-jolo-v4-4-1>`__
      - v4.4.1
