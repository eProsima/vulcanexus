...
.. list-table::
    ...
    * - ROS 2 Router
      ...
      - v4.3.0
    * - ROS 2 Shapes Demo
      - `v3.2.2 <https://eprosima-shapes-demo.readthedocs.io/en/latest/notes/notes.html#version-3-2-2>`__
      - v4.3.0
    ...
    * - Vulcanexus Fast DDS RMW
      - `v4.2.0 <https://github.com/eProsima/rmw_fastrtps/releases/tag/v4.2.0>`__
      - v4.3.0
    * - eProsima Dev Utils
    ...
    * - eProsima DDS Record & Replay
      - `v1.2.0 <https://dds-recorder.readthedocs.io/en/latest/rst/notes/notes.html#version-v1-2-0>`__
      - v4.3.0
    * - eProsima Fast DDS Spy
      - `v1.2.0 <https://fast-dds-spy.readthedocs.io/en/latest/rst/notes/notes.html#version-v1-2-0>`__
      - v4.3.0
    * - Vulcanexus IDL Dynamic TypeSupport Fast DDS
      ...
      - v4.1.0
    * - Vulcanexus Base
      - `v4.3.0 <https://docs.vulcanexus.org/en/latest/rst/notes/jazzy/notes.html#jazzy-imagination-v4-3-0>`__
      - v4.3.0
