...
.. list-table::
    ...
    * - ROS 2 Router
      ...
      - v2.5.0
    * - ROS 2 Shapes Demo
      - `v2.14.5 <https://eprosima-shapes-demo.readthedocs.io/en/latest/notes/previous_versions/supported_versions.html#version-2-14-5>`__
      - v2.9.0
    ...
    * - Vulcanexus IDL TypeSupport Fast DDS
      - `v2.9.0 <https://github.com/eProsima/rosidl_typesupport_fastrtps/releases/tag/v2.7.0>`__
      - v2.9.0
    * - Vulcanexus IDL
      - `v2.9.0 <https://github.com/eProsima/rosidl/releases/tag/v2.7.0>`__
      - v2.9.0
    * - Vulcanexus Base
      - `v2.9.0 <https://docs.vulcanexus.org/en/latest/rst/notes/humble/notes.html#humble-hierro-v2-8-0>`__
      - v2.9.0
