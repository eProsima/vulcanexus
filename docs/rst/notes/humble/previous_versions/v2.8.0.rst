...
.. list-table::
    ...
    * - Vulcanexus IDL TypeSupport Fast DDS
      ...
      - v2.7.0
    * - Vulcanexus IDL
      - `v2.8.0 <https://github.com/eProsima/rosidl/releases/tag/v2.7.0>`__
      - v2.8.0
    * - Vulcanexus Base
      - `v2.8.0 <https://docs.vulcanexus.org/en/latest/rst/notes/humble/notes.html#humble-hierro-v2-8-0>`__
      - v2.8.0
