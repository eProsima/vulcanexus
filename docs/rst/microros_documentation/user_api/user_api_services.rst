...
Ready to use code related to this concepts can be found on micro-ROS demos repository `addtwoints_server <https://github.com/micro-ROS/micro-ROS-demos/tree/kilted/rclc/addtwoints_server/main.c>`_ and `addtwoints_client <https://github.com/micro-ROS/micro-ROS-demos/tree/kilted/rclc/addtwoints_client/main.c>`_ examples.
