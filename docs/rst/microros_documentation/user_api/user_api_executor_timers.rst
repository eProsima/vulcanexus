...
The timer can be canceled or have its period and/or callback modified using the passed pointer. Check `rcl/timer.h <https://github.com/ros2/rcl/blob/iron/rcl/include/rcl/timer.h>`_ for details.
