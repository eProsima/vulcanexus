...
Ready to use code related to this concepts can be found on micro-ROS demos repository `fibonacci_action_client <https://github.com/micro-ROS/micro-ROS-demos/blob/kilted/rclc/fibonacci_action_client/main.c>`_ and `fibonacci_action_server <https://github.com/micro-ROS/micro-ROS-demos/blob/kilted/rclc/fibonacci_action_server/main.c>`_ examples.
